...
<div class="row">
    ...
    <x-inputs.group class="col-md-12">
        <x-inputs.text name="user_type" label="User Type" :value="old('user_type', $editing ? $userSupport->user_type : '')" maxlength="255" placeholder="User Type">
        </x-inputs.text>
    </x-inputs.group>
    ...
    <x-inputs.group class="col-md-12">
        <x-inputs.select name="building_id[]" label="Building" multiple='' data-placeholder="Select Building" style="width: 100%;">
