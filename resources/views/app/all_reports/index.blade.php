    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">
                    @lang('crud.all_reports.index_title')
                </h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-condensed">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    @can('update', $reports)
                                    <a
                                        href="{{ route('all-reports.edit', $reports) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    <a
                                        href="{{ route('all-reports.show', $reports) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('delete', $reports)
                                    <form
                                        action="{{ route('all-reports.destroy', $reports) }}"
                                        method="POST"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2">{!! $allReports->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
