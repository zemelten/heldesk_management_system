...
<div class="row">
    <x-inputs.group class="col-md-12">
        <x-inputs.text name="name" label="Name" :value="old('name', $editing ? $problem->name : '')" maxlength="255" placeholder="Name"></x-inputs.text>
    </x-inputs.group>
    ...
    <x-inputs.group class="col-md-12">
        <x-inputs.textarea name="description" label="Description" maxlength="255">
            {{ old('description', $editing ? $problem->description : '') }}</x-inputs.textarea>
    </x-inputs.group>
</div>
