...
<head>
    ...
    <link rel="stylesheet" id="wc-blocks-vendors-style-css"
        href="https://149842454.v2.pressablecdn.com/wp-content/plugins/woocommerce/packages/woocommerce-blocks/build/wc-blocks-vendors-style.css"
        type="text/css" media="all">
    <link rel="stylesheet" id="wc-blocks-style-css"
        href="https://149842454.v2.pressablecdn.com/wp-content/plugins/woocommerce/packages/woocommerce-blocks/build/wc-blocks-style.css"
        type="text/css" media="all">
    ...
    <link rel="stylesheet" id="classic-theme-styles-css"
        href="https://149842454.v2.pressablecdn.com/wp-includes/css/classic-themes.min.css" type="text/css"
        media="all">
    ...
    <link rel="stylesheet" id="contact-form-7-css"
        href="https://149842454.v2.pressablecdn.com/wp-content/plugins/contact-form-7/includes/css/styles.css"
        type="text/css" media="all">
    ...
    <link rel="stylesheet" id="_mbbasetheme-style-css"
        ...
        media="all">
    <link rel="stylesheet" id="sv-wc-payment-gateway-payment-form-v5_10_12-css"
                                                ...
                                                <div class="btn-actions-pane-right actions-icon-btn">
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <div class="p-3 text-right">
                                                                <button
                                                                    class="mr-2 btn-shadow btn-sm btn btn-link">View
                                                                    Details
                                                                </button>
                                                                <button
                                                                    class="mr-2 btn-shadow btn-sm btn btn-primary">
                                                            ...
                                                            <div class="p-2">
                                                                <div class="chat-wrapper p-1">
                                                                    <div class="chat-box-wrapper">
                                                                        ...
                                                                        <div>
                                                                            <div class="chat-box">But I must explain
                                                                                to you
