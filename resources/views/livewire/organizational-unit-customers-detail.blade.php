<div>
    ...
    <x-modal id="organizational-unit-customers-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-md-12">
                        <x-inputs.select
                            name="customer.building_id"
                            label="Building"
                            wire:model="customer.building_id"
                        >
        ...
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.organizational_unit_customers.inputs.full_name')
                    </th>
                    <th class="text-left">
                    ...
                    <th class="text-left">
                        @lang('crud.organizational_unit_customers.inputs.campus_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.organizational_unit_customers.inputs.floor_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.organizational_unit_customers.inputs.user_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.organizational_unit_customers.inputs.is_edited')
                    </th>
                    <th class="text-left">
                        @lang('crud.organizational_unit_customers.inputs.office_num')
                    </th>
                    <th></th>
                </tr>
            </thead>
