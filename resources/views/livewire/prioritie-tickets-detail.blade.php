<div>
    ...
    <x-modal id="prioritie-tickets-modal" wire:model="showingModal">
        ...
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.prioritie_tickets.inputs.status')
                    </th>
                    <th class="text-left">
                        @lang('crud.prioritie_tickets.inputs.description')
                    </th>
                    <th class="text-left">
                        @lang('crud.prioritie_tickets.inputs.campuse_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.prioritie_tickets.inputs.problem_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.prioritie_tickets.inputs.organizational_unit_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.prioritie_tickets.inputs.user_support_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
