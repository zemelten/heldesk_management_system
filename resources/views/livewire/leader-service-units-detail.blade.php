<div>
    ...
    <x-modal id="leader-service-units-modal" wire:model="showingModal">
                ...
                <div>
                    ...
                    <x-inputs.group class="col-md-12">
                        <x-inputs.select
                            ...
                            label="Unit"
                            wire:model="serviceUnit.unit_id"
                        >
        ...
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.leader_service_units.inputs.name')
                    </th>
                    <th class="text-left">
                        @lang('crud.leader_service_units.inputs.telephone')
                    </th>
                    <th class="text-left">
                        @lang('crud.leader_service_units.inputs.fax')
                    </th>
                    <th class="text-left">
                        @lang('crud.leader_service_units.inputs.email')
                    </th>
                    <th class="text-left">
                        @lang('crud.leader_service_units.inputs.discription')
                    </th>
                    <th class="text-left">
                        @lang('crud.leader_service_units.inputs.unit_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
