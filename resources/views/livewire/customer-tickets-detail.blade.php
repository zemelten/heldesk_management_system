<div>
    ...
    <x-modal id="customer-tickets-modal" wire:model="showingModal">
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.customer_tickets.inputs.status')
                    </th>
                    <th class="text-left">
                        @lang('crud.customer_tickets.inputs.description')
                    </th>
                    <th class="text-left">
                        @lang('crud.customer_tickets.inputs.campuse_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.customer_tickets.inputs.problem_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.customer_tickets.inputs.organizational_unit_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.customer_tickets.inputs.user_support_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.customer_tickets.inputs.prioritie_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
