<div>
    ...
    <x-modal id="service-unit-user-supports-modal" wire:model="showingModal">
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.service_unit_user_supports.inputs.user_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.service_unit_user_supports.inputs.user_type')
                    </th>
                    <th class="text-left">
                        @lang('crud.service_unit_user_supports.inputs.problem_catagory_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.service_unit_user_supports.inputs.building_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.service_unit_user_supports.inputs.unit_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
