<div>
    ...
    <x-modal id="leader-user-supports-modal" wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.group class="col-sm-12">
                        <x-inputs.select
                            name="userSupport.building_id"
                            label="Building"
                            wire:model="userSupport.building_id"
                        >
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.leader_user_supports.inputs.user_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.leader_user_supports.inputs.user_type')
                    </th>
                    <th class="text-left">
                        @lang('crud.leader_user_supports.inputs.problem_catagory_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.leader_user_supports.inputs.building_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.leader_user_supports.inputs.service_unit_id')
                    </th>
                    <th class="text-left">
                        @lang('crud.leader_user_supports.inputs.unit_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
